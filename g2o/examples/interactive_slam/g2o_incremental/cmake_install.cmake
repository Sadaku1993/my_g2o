# Install script for directory: /home/amsl/my_ros_pkg/my_g2o/g2o/examples/interactive_slam/g2o_incremental
...
FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/amsl/my_ros_pkg/my_g2o/lib/libg2o_incremental.so")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so")
...
FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/amsl/my_ros_pkg/my_g2o/bin/g2o_incremental")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/g2o_incremental" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/g2o_incremental")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/g2o_incremental")
...
FILE(INSTALL DESTINATION "/usr/local/include/g2o/examples/interactive_slam/g2o_incremental" TYPE FILE FILES
    "/home/amsl/my_ros_pkg/my_g2o/g2o/examples/interactive_slam/g2o_incremental/linear_solver_cholmod_online.h"
    "/home/amsl/my_ros_pkg/my_g2o/g2o/examples/interactive_slam/g2o_incremental/graph_optimizer_sparse_incremental.h"
    "/home/amsl/my_ros_pkg/my_g2o/g2o/examples/interactive_slam/g2o_incremental/g2o_incremental_api.h"
    )
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
